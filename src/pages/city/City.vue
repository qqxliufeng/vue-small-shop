<template>
<div class='c-city-container'>
    <navi title="选择城市" :isFixed="true"></navi>
    <div class="city-content">
      <v-distpicker type="mobile" hide-area @selected="selectedCity" :placeholders="{province: '请选择省份', city: '请选择市', area: '区'}"></v-distpicker>
    </div>
</div>
</template>
