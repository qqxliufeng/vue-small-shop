<template>
	<div class="scenic-type-list-container">
		...
		<popup ref='popup'>
			<div v-for="(item, index) of dialogTempList" :key="index" style="display: inline-block; width: 20%; height: 25vw;">
				<div class="type-wrapper" @click="dialogItemClick(item)">
					<img :src="$utils.image.getImagePath(item.image)" class="type-icon" :class="{ 'selected-type-image': item.isSelected }"/>
